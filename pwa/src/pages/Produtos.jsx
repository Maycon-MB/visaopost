  ...
  return (
    <>
      <div className="page-header">
        <div>
          <div className="eyebrow"><span className="eyebrow-num">04</span> Catálogo</div>
          <h1 className="page-title">Vitrine <em className="text-italic-serif" style={{ color: 'var(--champagne)' }}>digital</em></h1>
          <p className="page-sub">As fotos que aparecem no seu site público. Arraste pra reordenar.</p>
        </div>
      ...
      <p className="muted" style={{ marginTop: 28, fontSize: 13, textAlign: 'center' }}>
        <span className="ornament">✻</span> Fase 6f: upload real + reordenar drag-drop + tabela `products`. Hoje é amostra visual.
      </p>
    </>
  );
}
